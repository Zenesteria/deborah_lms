...
export default function Borrowed_Books({ book_data }: compProps) {
  ...
  return (
    <div
      className="w-full z-[200] relative rounded-xl my-10 "
      style={{ animation: "slide_up 1s ease" }}
    >
      <div className="w-full flex flex-wrap justify-between">
        <Table data={data} columns={columns} title="Borrowed Books" />
      </div>
    </div>
  );
}
