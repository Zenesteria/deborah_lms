      ...
      <div className="flex-1 min-h-screen p-10 h-fit bg-main-one rounded-xl relative overflow-hidden">
        ...
        >
          ...
          <div className="flex-1">
            <h1 className="text-red-500">{dashboardState.fullName}</h1>
        ...
        dashboardState.view == "Overdue Books" ? (
          <div className="flex flex-wrap w-full h-fit max-h-[130px] min-h-[10vh] duration-500 z-[200] my-10 relative">
            <InfoCard_A val={0} Icon={FaUsers} title="Total Visitors" />
            <InfoCard_A val={borrowed_books_len.length} Icon={GiBookshelf} title="Borrowed Books" />
            <InfoCard_A val={overdue_books_len.length} Icon={FaHourglass} title="Overdue Books" />
        ...
        {dashboardState.view == "default" ? (
          ...
          >
            ...
            <div className="flex flex-wrap w-full">
              {dashboardState.books.slice(0,3).map((book) => {
                return(<Book link="" img={book.coverImage} />)
              })}
            </div>
